...
extern "C" {
    ...
    */
    ...
    // release the compute buffers reserved by the scheduler without destroying the
    // scheduler; the next graph allocation will reserve them again, possibly smaller
